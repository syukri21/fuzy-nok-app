    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <!--  add operator-->
                <form action="/qr/edit/<?= $data['id'] ?>" method="post">

                    <!--                    code, data, type-->
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-dark" for="code">Code</label>
                        <div class="input-group col-sm-10 px-0">
                            <input type="text" class="form-control " value="<?= $data['code'] ?>" id="code" name="code"
                                   placeholder="Code"
                                   required>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-dark" value="<?= $data['type'] ?>"
                               for="type">Type</label>
                        <!--                       select [mesin, seal]-->
                        <select class="form-control col-sm-10" id="type" disabled name="type">
                            <option value="machine" selected="selected">Mesin</option>
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-dark" value="<?= $data['job'] ?>"
                               for="job">Job</label>
                        <input type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control col-sm-10" value="<?= $data['noJobDesk'] ?>"
                               id="noJobDesk" name="noJobDesk"
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control col-sm-10" value="<?= $data['item'] ?>" id="noJobDesk"
                               name="item"
                               placeholder="Item"/>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="number" class="form-control col-sm-10" value="<?= $data['cav'] ?>" id="noJobDesk"
                               name="cav"
                        />
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="number" value="<?= $data['targetCycle'] ?>" class="form-control col-sm-10"
                               id="targetCycle" name="targetCycle"
                        />
                    </div>
